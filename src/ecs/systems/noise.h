...
namespace zombies {
    ...
    public:
        ...
        static double perlin_noise(float x, float y, std::vector<int> &p) {
            int z = 0.5;
            ...
            // Computer fade curves for each coordinate.
            double u = fade(x);
            double v = fade(y);
            double w = fade(z);

            // Hash the coordinates of 8 cube corners.
        ...
        static std::vector<int> get_permutation_vector() {
